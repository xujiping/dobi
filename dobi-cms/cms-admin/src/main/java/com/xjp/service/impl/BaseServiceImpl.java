...
public abstract class BaseServiceImpl<Mapper, Record, Example> implements BaseService<Record, Example> {
	...
	public int countByExample(Example example) {
		try {
			...
			Method countByExample = mapper.getClass().getDeclaredMethod("selectCountByExample", example.getClass());
	...
	public Record selectByPrimaryKey(Long id) {
		try {
			...
			Method selectByPrimaryKey = mapper.getClass().getDeclaredMethod("selectByPrimaryKey", id.getClass().getSuperclass().getSuperclass());
